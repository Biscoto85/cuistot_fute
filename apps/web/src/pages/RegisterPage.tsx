  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-stone-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <p className="mb-1 text-sm text-stone-400">Cuistot Futé — la charge mentale, c'est cuit.</p>
        <p className="mb-8 text-xs text-stone-400">2 générations de plan offertes à la création du compte.</p>
