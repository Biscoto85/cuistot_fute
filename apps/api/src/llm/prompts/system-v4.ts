...
// Modifications vs v3 :
// - Garde-manger : état de stock déclaré (ok/bas/vide) avec règles d'usage
// - Principe 7 : régime alimentaire ({{diet_regime}}) + option poisson ({{fish_rule}})
// - Principe 8 : niveau de menu ({{menu_tier}}) économique/normal/luxe
// - Renumérotation des principes suivants
...
11. PETIT-DÉJEUNER : si demandé, propose 2-3 options récurrentes + prep dominicale si possible.
